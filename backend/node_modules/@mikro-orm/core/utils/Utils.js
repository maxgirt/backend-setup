...
exports.Utils = exports.parseJsonSafe = exports.equals = exports.compareBuffers = exports.compareBooleans = exports.compareArrays = exports.compareObjects = exports.ObjectBindingPattern = void 0;
...
class Utils {
    ...
    static dropUndefinedProperties(o, value, visited = new Set()) {
        if (Array.isArray(o)) {
            return o.forEach((item) => Utils.dropUndefinedProperties(item, value, visited));
        }
